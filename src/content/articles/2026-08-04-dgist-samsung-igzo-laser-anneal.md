...
summary: "DGIST·삼성전자 연구진이 텅스텐 게이트에 레이저를 한 번 쬐는 것만으로 산화물 TFT의 안정성(PBS 문턱전압 변화 83% 감소)과 접촉저항(59% 감소)을 동시에 잡았습니다. 커패시터 없는 D램 셀에서 데이터 유지율도 34.8%에서 87.9%로 뛰었습니다."
section: paper
reporter: PEER
...
|---|---:|---:|---|
| 이동도 | — | 37.9 cm²/V·s | 듀얼게이트 동작, VDS=0.1V |
| 문턱전압 | 음의 값 | +0.27 V | 듀얼게이트 동작, VDS=0.1V |
| on/off 전류비 | — | &gt;10⁹ | VDS=1V |
