...
export const UI = {
  ...
  en: {
    ...
    homeArchiveBand: 'Archive',
    homeArchiveTitle: 'Search every article we have published by title or company',
    homeArchiveByline: (n: number) => `All ${n} articles · search →`,
    homeFeedHead: 'All articles · newest first',
    homeFeedLink: (n: number) => `All ${n} in the archive →`,
